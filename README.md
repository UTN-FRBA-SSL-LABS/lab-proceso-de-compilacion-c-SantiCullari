...
> **R: Porque en matematica.o area_circulo está definido, mientras que en programa.o no lo está.**
...
> **R:004012a0 T __mingw32_init_mainargs
004015a8 T _area_circulo
004015ca T _factorial
00401592 T _imprimir_separador
00407020 B _llamadas
0040147a T _main
...
> **R:Las resuelve el cargador dinámico cuando el programa se ejecute**
...
> **R:Una macro función es un remplazo de texto sin lógica, mientras que una funcion si la tiene. La macro función "desaparece" en la etapa de preprocesamiento. La función real posee verificación de tipos**
...
> **R: T se guarda en la sección text y contiene funciones. D se guarda en la sección data y contiene variables globales con valor inicial**
...
> **R:        ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7fff65da0000)
        ntdll.dll => /c/Windows/SysWOW64/ntdll.dll (0x77000000)
        wow64.dll => /c/WINDOWS/System32/wow64.dll (0x7fff64d40000)
        wow64base.dll => /c/WINDOWS/System32/wow64base.dll (0x7fff64d30000)
        wow64win.dll => /c/WINDOWS/System32/wow64win.dll (0x7fff64a10000)
        wow64con.dll => /c/WINDOWS/System32/wow64con.dll (0x7fff64f80000)**

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R: libc funciona como pilar del lenguaje C, y como tal gcc lo carga automáticamente, ya que de no hacerlo no se podría ejecutar el resto del código**
